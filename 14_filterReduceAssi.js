...
console.log(``);
console.log(
  `-------------------- All Employees are working in Wipro company ----------------------------`
);
...
console.log(``);
console.log(
  `-------------------  All Employees from IT OR HR department ---------------------------`
);
...
console.log(
  `------------------- All Employees which one empId is greater than 50 --------------------------`
);
...
console.log(
  `------------------ All Employees whose name starts with 'A' OR 'V' OR 'M' -----------------`
);
...
console.log(
  `---------------  The awarage salary of employees ------------------------------`
);
...
console.log(
  `------------------- The average salary for IT department --------------------------`
);
